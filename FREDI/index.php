<?php $active=1; $title = "Accueil"; require('header.php'); ?>
    ...
    <br>
        ...
        <p>La maison des ligues Lorraine est une structure financée par le Conseil Régional. Elle a pour mission de fournir des espaces et des services aux différentes ligues sportives régionales et à d’autres structures hébergées</p>
        <br>
        <h2>Que proposons-nous ?</h2>
        <h2>Des missions</h2>
        <h3>Le personnel de la fredi et leurs missions</h3>
        <p>Les personnes qui travaillent ici sont de différentes catégories:</p>
        <ul>
          <li>Les «professionnels»
          <ul>
            <li>Deux employés du Conseil Régional (des factotums)</li>
            <li>Sept ETP (Équivalents Temps Plein) employés par le CROSL</li>
            <li>Le personnel des prestataires (gardiennage, ménage)</li>
            <li>Les salariés des ligues</li>
          </ul>
          </li>
          <br>
          <li>Les bénévoles qui sont les élus des associations
          <ul>
            <li>CROSL</li>
            <li>CDOS</li>
            <li>Ligues</li>
            <li>Comités départementaux</li>
            <li>Les élus du Conseil Régional</li>
          </ul>
          </li>
          <br>
          <li>Les autres
        ...
        <br> 
        <h3>Les missions des personnels "Région et "CROSL"</h3>
        <p>Nous avons 2,25 ETP « région »,deux factotums, M. Lucien Sapin.</p>
        <ul>
          <li>Les autres ETP du CROSL sont les suivants
          <ul>
            <li>0,75 ETP pour le poste de direction</li>
            ...
            <li>1 ETP d’infographiste et gestion des photocopieuses numériques</li>
        ...
        <p>Les ligues disposent d'un accès Internet mutualisé que la fredi loue à un prestataire extérieur</p>
        <h3>Accès wifi</h3>
        <p>Dans tous les espaces, un réseau Wifi "visiteurs" devra être disponible, avec une clé WPA renouvelée régulièrement et communiquée aux ligues. Ce réseau ne permettra que l'accès à Internet.</p>
        <h3>Téléphonie</h3>
        <p>Dans les bâtiments, les salles et bureaux sont équipés de prises de téléphone analogiques. La fredi y fournit les combinés téléphoniques.</p>
        ...
        <h3>Impressions</h3>
        <p>Les ligues disposent de la possibilité d'imprimer sur des ressources d'impression numériques connectées situées dans le local reprographie du rez-de-chaussée.</p>
        <h3>Serveur FTP documentaire et sauvegarde</h3>
        <p>La fredi met à disposition des ligues un serveur FTP documentaire intranet par étage regroupant des textes légaux, des modèles de dossiers, de statuts, des programmes de formation (...) compilés par le CROSL. Ce serveur devra également faire office de serveur de sauvegardes.</p>
        <h3>Gestion de la FAQ</h3>
        <p>La fredi met à disposition des ligues via l’intranet un site web personnalisé présentant leur activité. Tout internaute devra pouvoir se connecter à l’un des sites afin de poser des questions et consulter la FAQ . Pour cela il devra s’inscrire auprès du site et être authentifié.</p>
        <h3>Système de gestion des configurations</h3>
        <p>fredi gère à travers un logiciel de gestion des configurations l'ensemble du parc informatique incluant les postes fixes des ligues.</p>
